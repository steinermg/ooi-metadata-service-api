...
class MetadataServiceTest(unittest.TestCase):
    ...
    def test_create_stream_metadata_record(self):
        ##############
        # Test Setup #
        ##############
        self.test_get_stream_metadata_record_not_found()  # Confirm record doesn't already exist
        sk = self.__build_knockoff_stream_key()
        rec = metadata_service_api.build_stream_metadata_record(*(sk + (1.1, 2.2, 3)))
        ########
        # Test #
        ########
        ...
        # Cleanup #
        ###########
        self.stream_metadata_responses.append(actual_result)
